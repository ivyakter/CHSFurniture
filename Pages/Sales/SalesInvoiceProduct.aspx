<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/AdminMaster.master" AutoEventWireup="true" CodeFile="SalesInvoiceProduct.aspx.cs" Inherits="Pages_Sales_SalesInvoiceProduct" %>
                ...
                <asp:GridView ID="Gridview1" runat="server" ShowFooter="True" Width="100%" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="&nbsp; Product Item">
                          ...
                          <asp:DropDownList Width="95%"  ID="ddlproduct" CssClass="form-control js-example-placeholder-single" runat="server">
                                </asp:DropDownList>
                            </ItemTemplate>
                        </asp:TemplateField>
