<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/AdminMaster.master" AutoEventWireup="true" CodeFile="ViewSaleInvoice.aspx.cs" Inherits="Pages_Sales_ViewSaleInvoice" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="h2 text-red text-center">
       Accessories Sales Invoice List
    </div>
    <div class="row">
        <div class="col-md-3">
            From
    ...
    <asp:GridView ID="Gridview1" runat="server" PageSize="15" AllowPaging="true" OnRowCommand="Gridview1_RowCommand" OnPageIndexChanging="Gridview1_PageIndexChanging" AutoGenerateColumns="False"
        ...
        <Columns>
            ...
            <asp:BoundField DataField="TRType" Visible="false" HeaderText="Transection Type" />
            
            <asp:TemplateField HeaderText="Edit/Delete">
                <ItemTemplate>
                    <br />
                    &nbsp; &nbsp; &nbsp;
                    <asp:LinkButton ID="LinkButton1" runat="server" CommandName="DeleteRow" PostBackUrl='<%# String.Concat("SaleVoucherEdit.aspx?Id=", Eval("VoucherNo").ToString()) %>'>
                        <span aria-hidden="true" class="glyphicon glyphicon-edit"></span>
                        </asp:LinkButton>
                    <%--<asp:Button ID="btnEdit" runat="server" Text="Edit" CssClass="btn-success"
                PostBackUrl='<%# String.Concat("SaleVoucherEdit.aspx?Id=", Eval("VoucherNo").ToString()) %>' />--%>
                    &nbsp; &nbsp; &nbsp; &nbsp;
