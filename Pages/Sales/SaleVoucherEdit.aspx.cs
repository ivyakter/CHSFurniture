...
public partial class Pages_Sales_SaleVoucherEdit : System.Web.UI.Page
{
        ...
        if (ViewState["CurrentTable"] != null)
        {
            ...
            if (dtCurrentTable.Rows.Count > 0)
            {
                for (int i = 1; i <= dtCurrentTable.Rows.Count; i++)
                {
                    ...
                    DropDownList box2 = (DropDownList)Gridview1.Rows[rowIndex].Cells[2].FindControl("ddlModel"); 
    ...
    protected void Gridview1_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            HiddenField hfddlItem = (HiddenField)e.Row.FindControl("hfddlItem");
            type.SelectedItem.Text = hfddlItem.Value;
            ...
            HiddenField hfddlModel = (HiddenField)e.Row.FindControl("hfddlModel");
            model.SelectedItem.Text = hfddlModel.Value;
            ...
            HiddenField hfddlUnit = (HiddenField)e.Row.FindControl("hfddlUnit");
            unit.SelectedItem.Text = hfddlUnit.Value;
        }
    }
    ...
    public void LoadDate()
    {
        ...
        {
            txtVoucherName.Text = Request.QueryString["Id"];

            DataTable dt1 = mydal.GetSalesVoucherList1(txtVoucherName.Text);
            ddlClientname.SelectedValue = dt1.Rows[0]["ClientId"].ToString();
            ddlClientname.SelectedItem.Text = dt1.Rows[0]["ClientName"].ToString();
            txtDate.Text = dt1.Rows[0]["date"].ToString();
            txtComment.Text = dt1.Rows[0]["Comment"].ToString();
            lbltotal.Text = dt1.Rows[0]["TotalAmount"].ToString();

            DataTable dt2 = mydal.GetSalesVoucherList2(txtVoucherName.Text);
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        {
            bool delete = mydal.DeleteSaleVoucher(txtVoucherName.Text);
            ...
            if (IsSuccess == true)
            {
                ...
                if (ViewState["CurrentTable"] != null)
                {
                    ...
                    if (dtCurrentTable.Rows.Count > 0)
                    {
                        for (int i = 1; i <= dtCurrentTable.Rows.Count; i++)
                        {
                            ...
                            bool Success = mydal.InsertSalesItem(ddlClientname.SelectedValue, txtVoucherName.Text, ddlItem.SelectedItem.ToString(), ddlModel.SelectedItem.ToString(), txtPrice.Text, ddlUnit.SelectedItem.Text, txtQuantity.Text, txtTotal.Text, Itemname, txtDate.Text);

                            bool InsertRecive_PaymentFromSales = mydal.InsertRecive_PaymentFromSales(ddlClientname.SelectedValue, ddlItem.SelectedItem.Text, ddlClientname.SelectedItem.Text, txtVoucherName.Text, txtDate.Text, txtAllTotal.Text);
                                ...
                                //else
                                //{                               
                                //    ClientScript.RegisterStartupScript(this.GetType(), "ale", "alert('There Is no Accessories In This Name!!!!');", true);
                                //}                            
                ...
                string strconfirm = "<script>if(window.confirm('Update Information Successfully!!!!')){window.location.href='ViewSaleInvoice.aspx'}</script>";
    ...
    protected void ddlModel_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        DataTable dt = mydal.GetProductSalesPrice(product.SelectedItem.ToString(), model.SelectedItem.ToString());
