<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/AdminMaster.master" AutoEventWireup="true" CodeFile="BankTransfer.aspx.cs" Inherits="Pages_Accounts_BankTransfer" %>
                ...
                <div class="col-md-6">
                    <div class="row form-group">
                        <div class="col-md-4" style="padding-left: 0px;">
                            <asp:Label ID="label5" runat="server"  Text="Transfer From"></asp:Label>
                        </div>
                        <div class="col-sm-6">
                            <asp:DropDownList ID="ddlIncomeType" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlIncomeType_SelectedIndexChanged" CssClass="form-control">                               
                            </asp:DropDownList>
        ...
        <div class="col-md-12">
            <div class="row">
                <div class="col-md-6">
                    <div class="row form-group">
                        <div class="col-md-4">
                            <asp:Label ID="label8" runat="server" Visible="false" Text="Bank Name"></asp:Label>
                        </div>
                        <div class="col-sm-6">
                            <asp:DropDownList ID="ddlBank" runat="server" Visible="false" CssClass="form-control" AutoPostBack="true">
                                </asp:DropDownList>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="row">
                        <div class="row form-group">
                            <div class="col-md-4">
                                <asp:Label ID="label3" runat="server" Visible="false" Text="Transaction No"></asp:Label>
                            </div>
                            <div class="col-sm-6">
            ...
            <asp:GridView ID="Gridview1" runat="server" ShowFooter="True" Width="100%" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="&nbsp;Transfer To">
                        <ItemTemplate>
                          <%--  <asp:DropDownList Width="95%" ID="ddlvendorname" AutoPostBack="true" OnSelectedIndexChanged="ddlvendorname_SelectedIndexChanged" runat="server">
                            </asp:DropDownList>--%>
                            <asp:DropDownList ID="ddlIncomeTypeTo" Width="80%" runat="server"  AutoPostBack="true"
                                ontextchanged="ddlIncomeTypeTo_TextChanged">                               
                            </asp:DropDownList>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="Vendor COAID" Visible="false">
                     ...
                     <asp:TemplateField HeaderText="Bank Name">
                        <ItemTemplate>
                              <asp:DropDownList ID="ddlBankTo" runat="server" Visible="false" CssClass="form-control" AutoPostBack="true">
                                </asp:DropDownList>
                        </ItemTemplate>
                    </asp:TemplateField>                
                    ...
                    <asp:TemplateField HeaderText="Transaction No">
                        <ItemTemplate>
                            <asp:TextBox ID="txtdescription" TextMode="MultiLine" Height="20px" runat="server" Width="100%" />
                        </ItemTemplate>
