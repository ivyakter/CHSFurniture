...
public partial class Pages_Accounts_ViewPaymentVoucher : System.Web.UI.Page
{
    DAL mydal = new DAL();
    ...
    {
        DataTable dt = mydal.GetReceiveVoucherList();
    ...
    protected void txtSearch_TextChanged(object sender, EventArgs e)
    {
        if (txtSearch.Text != "")
        {
            DataTable dt = mydal.GetReceiveVoucherList(txtSearch.Text);
            Gridview1.DataSource = dt;
            Gridview1.DataBind();
        }
        else
    ...
    protected void Gridview1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName.Equals("DeleteRow"))
        {
            ...
            bool delete = mydal.DeleteReciveVoucher(VoucherNo);
            GetExpenseVoucher();
        }
    }
