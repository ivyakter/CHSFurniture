<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/AdminMaster.master" EnableEventValidation="false" MaintainScrollPositionOnPostback="true"
    AutoEventWireup="true" CodeFile="JournalEntries.aspx.cs" Inherits="Pages_Accounts_JournalEntries" %> 
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="row form-group">
                            <div class="col-md-4">
                                <asp:Label ID="label" runat="server" Text="Journal Serial No"></asp:Label>
                            </div>
                            <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="row form-group">
                            <div class="col-md-4">
                                <asp:Label ID="lblreference" runat="server" Text="Date:"></asp:Label>
                            </div>
                            <div class="col-md-6">      
                               <asp:TextBox ID="txtDate" runat="server" CssClass="form-control" Style="height: 18px;
                                ...
                                <asp:DropDownList ID="ddlCashorCredit" runat="server" Visible="false" AutoPostBack="true" OnSelectedIndexChanged="ddlCashorCredit_SelectedIndexChanged" CssClass="form-control">                               
                            </asp:DropDownList>
                   ...
                   <asp:CheckBox ID="chkDoubleEntry" runat="server" Text="Single Entry" />
                </div>
            </div>
        </asp:Panel>
            ...
            <asp:GridView ID="Gridview1" runat="server" ShowFooter="True" Width="100%" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Chart of Account">
                        <ItemTemplate>
                            <asp:DropDownList ID="ddlChartofAccounts" runat="server" AutoPostBack="true" Width="450px" OnSelectedIndexChanged="ddlChartofAccounts_SelectedIndexChanged1" CssClass="form-control js-example-placeholder-single">
                            </asp:DropDownList>
                        </ItemTemplate>
                    </asp:TemplateField>                 
                    <asp:TemplateField HeaderText="Debit">
                        <ItemTemplate>
                            <asp:TextBox ID="txtDebit"  OnTextChanged="txtDebit_TextChanged" Text="0" AutoPostBack="true" runat="server" Width="90%"></asp:TextBox>
                        </ItemTemplate>
                            <FooterTemplate>
                            <asp:Label ID="lblDebitTotal" Text="0" Font-Bold="true" runat="server" />
                        </FooterTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Credit">
                        <ItemTemplate>
                            <asp:TextBox ID="txtCredit"  AutoPostBack="true" OnTextChanged="txtCredit_TextChanged" Text="0" runat="server" Width="90%"></asp:TextBox>
                        </ItemTemplate>
                        <FooterTemplate>
                            <asp:Label ID="lblCreditTotal" Text="0"  Font-Bold="true" runat="server" />
                        </FooterTemplate>
                    </asp:TemplateField>                      
  ...
  <%--      <div style="height: 20px; width: 90%; text-align: right;">
        ...
        <div class="form-group">
            <div class="col-sm-6">
            <asp:TextBox ID="txtNarration" runat="server" TextMode="MultiLine" CssClass="form-control" Placeholder="Narrarion"></asp:TextBox>
            </div>
            <div class="col-sm-3">            

                    <asp:Button ID="btnSave" runat="server"  CssClass="btn-success" Width="100px" Text="Save" OnClick="btnSave_Click" />
            </div>
            <div class="col-sm-3">
