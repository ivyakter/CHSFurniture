<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/AdminMaster.master" EnableEventValidation="false" AutoEventWireup="true" CodeFile="PaymentVoucher.aspx.cs" Inherits="Pages_Accounts_PaymentVoucher" %>
            ...
            <asp:GridView ID="Gridview1" runat="server" ShowFooter="True" Width="100%" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="&nbsp;Name of Legder">
                        <ItemTemplate>
                            <asp:DropDownList Width="95%" ID="ddlvendorname" CssClass="form-control js-example-placeholder-single" AutoPostBack="true" OnSelectedIndexChanged="ddlvendorname_SelectedIndexChanged" runat="server">
                            </asp:DropDownList>
                        </ItemTemplate>
                    </asp:TemplateField>
