...
public partial class Pages_Report_PaymentVoucherReport : System.Web.UI.Page
{
    DAL mydal = new DAL();
    ...
    public void reportLoad()
    {
        ...
        string date1 = Session["datefrom"].ToString();
        string date2 = Session["dateto"].ToString();
        ...
        try
        {
            ...
            DataTable dt = mydal.GetReceiveVoucherReport(date1, date2);
