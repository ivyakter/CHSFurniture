...
public partial class Pages_Procurement_PurchaseAccessoriesEdit : System.Web.UI.Page
{
    DAL mydal = new DAL();
    ...
    public void LoadData()
    {
        if (Request.QueryString["Id"] != "")
        {
            ...
            DataTable dt1 = mydal.GetPurchaseAcc1(txtVoucherName.Text);
            ddlsuppliername.SelectedItem.Text = dt1.Rows[0]["SupplierName"].ToString();
            ...
            txtsupplierid.Text = dt1.Rows[0]["SupplierID"].ToString();

            DataTable dt2 = mydal.GetPurchaseAcc2(txtVoucherName.Text);
            ...
            if (txtshippingcost.Text == "") txtshippingcost.Text = "0";
            btncostgenerate_Click(null, null);
        }
    }
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        {
            bool delete = mydal.DeletePurchaseAccessories(txtVoucherName.Text);
            ...
            string strconfirm = "<script>if(window.confirm('Update Information Successfully!!!!')){window.location.href='ViewPurchaseAccessories.aspx'}</script>";
