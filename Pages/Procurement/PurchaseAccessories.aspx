<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/AdminMaster.master" AutoEventWireup="true" CodeFile="PurchaseAccessories.aspx.cs" Inherits="Pages_Procurement_PurchaseBulk" %>
                    ...
                    <asp:GridView ID="Gridview1" runat="server" ShowFooter="True" Width="100%" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="&nbsp; Product Item">
                                ...
                                <ItemTemplate>
                                    <asp:DropDownList Width="95%" ID="ddlModel" runat="server"  CssClass="form-control js-example-placeholder-single" AutoPostBack="true" onselectedindexchanged="ddlModel_SelectedIndexChanged">
                                    </asp:DropDownList>
                                </ItemTemplate>
                            </asp:TemplateField>
                        ...
                        <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Cost">
                                <ItemTemplate>
                                    <asp:TextBox ID="txtcost" runat="server"  Width="95%" />
                                </ItemTemplate>
                            </asp:TemplateField>

                             <asp:TemplateField HeaderText="Cost/Unit">
                                <ItemTemplate>
                                    <asp:TextBox ID="txtcostperunit" runat="server"  Width="95%" />
                                </ItemTemplate>
                            </asp:TemplateField>
