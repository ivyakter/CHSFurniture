<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/AdminMaster.master" AutoEventWireup="true" CodeFile="ListCategory.aspx.cs" Inherits="Pages_InformationSetup_ListCategory" %>
    ...
    <asp:GridView ID="gv" runat="server" AutoGenerateColumns="false"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="&nbsp;&nbsp; Edit">
                <ItemTemplate>
                    <asp:Button CssClass="btn-edit" ID="btnEdit" runat="server" Text="Edit" PostBackUrl='<%# String.Concat("AddCategory.aspx?ID=", Eval("Id").ToString()) %>'
