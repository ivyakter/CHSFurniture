...
public partial class Pages_Inventory_ProductionReport : System.Web.UI.Page
{
    DAL mydal = new DAL();
    ...
    protected void txtDate2_TextChanged(object sender, EventArgs e)
    {
        ...
        DataTable dt = mydal.GetProductionReportByDay(date1, date2);
        if (dt.Rows.Count > 0)
        {
    ...
    protected void ddlitem_SelectedIndexChanged(object sender, EventArgs e)
    {
        var date1 = DateTime.Parse(txtDate1.Text);
        var date2 = DateTime.Parse(txtDate2.Text);
        DataTable dt = mydal.GetProductiondetailsbyProductName(ddlitem.SelectedValue, date1, date2);
        GridView1.DataSource = dt;
        GridView1.DataBind();
    }
